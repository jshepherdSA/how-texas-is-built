  ...
  return (
    <div className="page--accent" style={{ '--accent': ACCENT }}>
      ...
      <article className="article reveal">
        ...
        <figure>
          <Image src="/images/jobs-economic-impact/1-economic-impact-stats.png" alt="Economic impact statistics: $10+ billion in annual economic activity, 100,000+ high-earning Texas jobs, 300 million tons of aggregates produced annually, and 16%+ of total U.S. ready-mix concrete supply" width={2752} height={1536} style={{ width: '100%', height: 'auto' }} sizes="(max-width:700px) 90vw, 1000px" />
        </figure>
        ...
        <figure>
          <Image src="/images/jobs-economic-impact/2-supporting-quality-jobs-and-careers.png" alt="Supporting quality jobs and careers: pay ranging from $50,000 to $90,000 leading to six-figure earnings, work that is immune to AI disruption, and local jobs that cannot be outsourced because materials are sourced within the region" width={2172} height={724} style={{ width: '100%', height: 'auto' }} sizes="(max-width:700px) 90vw, 1000px" />
        </figure>
        ...
        <figure>
          <Image src="/images/jobs-economic-impact/3-wide-array-of-high-paying-careers.png" alt="A wide array of high-paying careers: skilled trades, technical experts, engineers and scientists, operations and management, and support professionals" width={1774} height={887} style={{ width: '100%', height: 'auto' }} sizes="(max-width:700px) 90vw, 1000px" />
        </figure>
        ...
        <figure>
          <Image src="/images/jobs-economic-impact/4-one-job-a-ripple-effect.png" alt="One job in the aggregates industry supports nearly six jobs in the local economy, and each $1 in wages earned creates another $4.95 of earnings in other sectors such as retail and services, housing, restaurants, education, and healthcare" width={1774} height={887} style={{ width: '100%', height: 'auto' }} sizes="(max-width:700px) 90vw, 1000px" />
        </figure>
