...
import EconomicImpactStats from '@/components/graphics/EconomicImpactStats';
  ...
  return (
    <div className="page--accent" style={{ '--accent': ACCENT }}>
      ...
      <article className="article article-body reveal">
        ...
        <JobsAndCareers accentColor={ACCENT} />
        ...
        <CareersGrid accentColor={ACCENT} />
        ...
        <RippleEffect accentColor={ACCENT} />
