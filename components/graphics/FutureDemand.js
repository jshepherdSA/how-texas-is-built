...
const CARDS = [
  { src: '/images/stock/8a.jpg', alt: 'An aerial view of a Texas aggregate quarry', stat: '15–50M Tons', label: 'Additional aggregates needed over the next decade' },
  { src: '/images/stock/8b.jpg', alt: 'A fleet of ready-mix concrete trucks at a Texas facility', stat: '3–10M Cubic Yards', label: 'Additional ready-mix concrete needed' },
  { src: '/images/stock/8c.jpg', alt: 'A Texas cement plant with large silos', stat: '1–3M Tons', label: 'Additional cement needed' },
];
