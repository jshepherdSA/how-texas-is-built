...
const CARDS = [
  { src: '/images/stock/5a.jpg', alt: 'A new Texas home under construction with concrete and aggregate', stat: '400 Tons', label: 'To build the average home' },
  { src: '/images/stock/5b.jpg', alt: 'A six-lane Texas highway with concrete pavement', stat: '15,000 Cubic Yards', label: 'Of concrete for one mile of six-lane highway' },
  { src: '/images/stock/5c.jpg', alt: 'A large modern Texas hospital exterior', stat: '30,000 Cubic Yards', label: 'Of concrete to build a modern hospital' },
  { src: '/images/stock/5d.jpg', alt: 'Texans using everyday roads and public infrastructure', stat: '50–60 lbs/day', label: 'Of aggregates used per American per day' },
];
